function Invoke-TestHarness
{
    ...
    Write-Verbose -Message 'Commencing all HardenedServerDSC tests'

    $repoDir = Join-Path -Path $PSScriptRoot -ChildPath "..\" -Resolve

    $testCoverageFiles = @()
    Get-ChildItem -Path "$repoDir\modules\HardenedServerDSC\DSCResources\**\*.psm1" -Recurse | ForEach-Object {
    ...
    Import-Module -Name "$repoDir\modules\HardenedServerDSC\HardenedServerDSC.psd1"
    $testsToRun = @()
